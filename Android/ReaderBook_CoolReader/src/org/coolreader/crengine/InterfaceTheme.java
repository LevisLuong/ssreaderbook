...
//////					0x000000, 0xE0);
//
//    public final static InterfaceTheme LIGHT = new InterfaceTheme("LIGHT", R.style.Theme_Light, R.string.options_app_ui_theme_light, 0xFF000000)
//
...
////					0x404040, 0xC0);
//
//    public final static InterfaceTheme DARK = new InterfaceTheme("DARK", R.style.Theme_Dark, R.string.options_app_ui_theme_dark, 0xFF000000)
//
...
//    }
//
//    private InterfaceTheme(String code, int themeId, int displayNameResourceId, int actionBarBackgroundColorReading) {
//        this.code = code;
