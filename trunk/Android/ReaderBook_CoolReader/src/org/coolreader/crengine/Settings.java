...
public interface Settings {
    ...
    public static final String PROP_DEF_ALIGN = "styles.def.align"; //
    public static final String PROP_DEF_IDENT = "styles.def.text-indent"; //
...
//    public static final String PROP_APP_SCREEN_ORIENTATION = "app.screen.orientation";
    ...
    public static class DictInfo {
        ...
        public DictInfo setDataKey(String key) {
            this.dataKey = key;
            return this;
        }
    }
